...
function renderMechanism(
    ...
    if (journalLink) {
        ...
        journalLink.href = "journal.html#reflection";
...
function renderReflection(
    ...
    question1.textContent =
        "Bạn có nhớ một tình huống gần đây trong đó bạn đã phản ứng theo một cách khiến bản thân chú ý không?";


    question2.textContent =
        "Khi nhìn lại tình huống đó, bạn nhận ra điều gì về trải nghiệm của mình? Nếu điều tương tự xảy ra lần nữa, bạn có thể muốn thử điều gì khác?";
